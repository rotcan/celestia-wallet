...
fn create_window<T>(
    ...
    //let viewport_id = egui::viewport::ViewportId::default();
...
fn _main(event_loop: EventLoop<Event>) {
    ...
    //let mut state = State::new(&ctx,&event_loop);
